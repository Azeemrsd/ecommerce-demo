...
// I need a search input - done
// that search input should capture value and send it to parent

// I need a select box
// I need unique categories in props as an array
// for this I need to construct an array of string with unique categories
